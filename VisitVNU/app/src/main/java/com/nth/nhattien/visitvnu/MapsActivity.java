...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void ChonDiaDiem(int pos, int i) {
        if (pos == 0) {
            if (i == 0) {
            ...
            if (i == 0) {
                ...
                //markerUIT.icon(BitmapDescriptorFactory.fromResource(R.drawable.placeholder));
                marker = mMap.addMarker(markerCIU);
            ...
            if (i == 1) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(Lau44).title("Lẫu Cá 44"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(Lau44)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 2) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(LC).title("Lẫu chay Hoằng Đạt"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(LC)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 3) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(NQ).title("Cơm Tấm Ngô Quyền"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(NQ)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 4) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(CQ).title("Cơm Quê"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(CQ)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 5) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(BH).title("Phở Bắc Hải"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(BH)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 6) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(MQ).title("Mì Quảng"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(MQ)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 7) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(BD).title("Bình Định Quán"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(BD)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 8) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(NN).title("Nhà hàng Năm Nhỏ"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(NN)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 9) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(QN).title("Quán Nhậu 76"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(QN)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 0) {
                ...
                //markerUIT.icon(BitmapDescriptorFactory.fromResource(R.drawable.placeholder));
                marker = mMap.addMarker(markerFC);
            ...
            if (i == 1) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(ZC).title("The Zero Coffee"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(ZC)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 2) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(BO).title("Trà Sữa Bobapop"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(BO)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 3) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(SKY).title("Trà Sữa Sky"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(SKY)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 4) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(BB).title("Trà sữa BonBon"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(BB)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 5) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(SNT).title("Sonata Coffee Acoustic"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(SNT)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 0) {
                ...
                //markerUIT.icon(BitmapDescriptorFactory.fromResource(R.drawable.placeholder));
                marker = mMap.addMarker(markerQS);
            ...
            if (i == 1) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(NGABA).title("Ngã Ba Hồ đá"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(NGABA)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 2) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(CONGIU).title("Cổng bên Đại học Quốc tế"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(CONGIU)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 3) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(CONDUONG).title("Con đường tình yêu"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(CONDUONG)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 4) {
                ...
                marker = mMap.addMarker(new MarkerOptions().position(KTXB).title("Ký túc xá khu B"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(KTXB)
                        .bearing(9.6f)
                        .tilt(90)
            ...
            if (i == 5) {
                LatLng US = new LatLng(10.875574, 106.799097);
                marker = mMap.addMarker(new MarkerOptions().position(US).title("Khuôn viên trường Đại học Khoa học Tự Nhiên"));
                CameraPosition cameraPosition = CameraPosition.builder()
                        .target(US)
                        .bearing(9.6f)
                        .tilt(90)
